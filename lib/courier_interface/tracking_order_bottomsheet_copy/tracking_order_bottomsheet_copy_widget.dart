...
import 'tracking_order_bottomsheet_copy_model.dart';
export 'tracking_order_bottomsheet_copy_model.dart';

class TrackingOrderBottomsheetCopyWidget extends StatefulWidget {
  const TrackingOrderBottomsheetCopyWidget({super.key});

  @override
  State<TrackingOrderBottomsheetCopyWidget> createState() =>
      _TrackingOrderBottomsheetCopyWidgetState();
}

class _TrackingOrderBottomsheetCopyWidgetState
    extends State<TrackingOrderBottomsheetCopyWidget> {
  late TrackingOrderBottomsheetCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TrackingOrderBottomsheetCopyModel());
