...
import 'scheduled_mission_model.dart';
export 'scheduled_mission_model.dart';

class ScheduledMissionWidget extends StatefulWidget {
  const ScheduledMissionWidget({super.key});

  @override
  State<ScheduledMissionWidget> createState() => _ScheduledMissionWidgetState();
}

class _ScheduledMissionWidgetState extends State<ScheduledMissionWidget> {
  late ScheduledMissionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ScheduledMissionModel());
