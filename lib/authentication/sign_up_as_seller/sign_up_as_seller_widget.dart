...
import 'sign_up_as_seller_model.dart';
export 'sign_up_as_seller_model.dart';

class SignUpAsSellerWidget extends StatefulWidget {
  const SignUpAsSellerWidget({super.key});

  @override
  State<SignUpAsSellerWidget> createState() => _SignUpAsSellerWidgetState();
}

class _SignUpAsSellerWidgetState extends State<SignUpAsSellerWidget> {
  late SignUpAsSellerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SignUpAsSellerModel());
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: FlutterFlowIconButton(
                        ...
                        onPressed: () async {
                          context.pushNamed('SignUp_as_courier');
                        },
                      ),
                    ),
                  ],
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    ...
                    context.pushNamedAuth(
                        'Seller_Dashboard_Home', context.mounted);
                  },
                  text: 'Sign up',
